...
const diensten = [
  {
    ...
    features: [
      ...
      "Inzet van verkeersregelinstallaties indien nodig",
      "Coördinatie met gemeente en Rijkswaterstaat",
      "Dag- en nachtdiensten mogelijk",
      "Landelijke dekking",
    ],
    flip: false,
  },
  ...
  },
  {
    ...
    desc: "Bij onverwachte situaties zoals ongelukken, overstromingen, gaslekkages of andere calamiteiten is snelle en professionele verkeersbegeleiding cruciaal. Safety Traffic Holland is 24 uur per dag, 7 dagen per week bereikbaar voor spoedopdrachten. Wij zijn binnen afzienbare tijd ter plaatse.",
    features: [
      "24/7 bereikbaar via telefoon en WhatsApp",
      "Snelle uitruk bij calamiteiten",
      "Samenwerking met hulpdiensten",
      "Ervaring met complexe en gevaarlijke situaties",
      "Documentatie en rapportage na afloop",
    ],
    flip: false,
  },
];
